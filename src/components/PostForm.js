  ...
  return (
    <div className='post-item'>
      ...
      <form onSubmit={submitForm}>
        ...
        <textarea id="post-text" value={text} onChange={(e) => {setText(e.target.value)}}></textarea>
        <label htmlFor="private-post"> Private: <input type="checkbox" checked={privatePost} onChange={() => {togglePrivate()}} /></label>
